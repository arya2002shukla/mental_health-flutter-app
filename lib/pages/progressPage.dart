...
import '../util/exercise_tile2.dart';
      ...
      body: ListView(padding: EdgeInsets.zero, children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: Color(0xFF00adb5), borderRadius: BorderRadius.circular(30)),
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              ExerciseTile2(
                ...
                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => Habitspage())),
              ),
              SizedBox(
                height: 10,
              ),
